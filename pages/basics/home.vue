<template name="basics">
  <view style="overflow:scroll;height: auto;">
    <!-- 顶部操作条 -->
    <view class="cu-bar bg-white cu-bar fixed nav fixed" :style="tophome" :class='hasNotchIn? "toTop" : " " '>
      <!-- 加载 -->
      ...
      <view class="content text-bold">
        {{ lookup == '' ? '泽宏云数据平台' : lookup + '数据平台' }}
      </view>
      <view class="action">
        工单<text class="cuIcon-roundrightfill text-grey" @click="Workorder"></text>
    ...
    <view>
      ...
      <view style="margin-top: 120rpx; background-color: #FFFFFF;height: 230rpx;">
        ...
        <view class="bg-grey padding-sm radius margin-top-sm  text-sm" style="width: 35%; margin-left: 50rpx;display: inline-block;">
          <view class="flex">
            <view class="flex-sub">设备报警率:<span style="color: #007AFF; margin-left: 15rpx;">{{deviceisusernum.percent_alarm}}
                %</span></view>
          </view>
        </view>
